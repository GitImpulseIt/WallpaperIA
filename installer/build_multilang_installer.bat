...
echo.
"%MAKENSIS%" /V3 WallpaperAI_Multilang.nsi
...
if exist "WallpaperAI-Setup-Multilang-1.0.2.exe" (
    echo Installateur cree: WallpaperAI-Setup-Multilang-1.0.2.exe
    for %%F in ("WallpaperAI-Setup-Multilang-1.0.2.exe") do echo Taille: %%~zF octets
) else (
