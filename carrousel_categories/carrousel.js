$(document).ready(function () {
    // Configuration
    const API_BASE_URL = 'https://kazflow.com/wallpaperai/api';
    const THUMBNAILS_PATH = 'https://kazflow.com/wallpaperai/api/miniatures/';
    ...
    function updateCarousel() {
        ...
        $('.carousel-slides').css('transform', `translateX(${offset}px)`);

        // Mettre à jour les dots
        $('.dot').removeClass('active');
        $(`.dot[data-page="${currentPage}"]`).addClass('active');
